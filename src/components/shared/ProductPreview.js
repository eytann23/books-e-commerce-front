...
const ProductPreview =(props)=>{
    ...
    const onClickProduct=(e)=>{
        if(!(isHover&&userData.user&&userData.user.isAdmin))
    ...
    >
        ...
        {(userData.user && userData.user.isAdmin)?
            isHover&&<ProductPreviewOverlay isbn={props.isbn} bookDetails={props} setIsHover={setIsHover} onClickAddToCart={onClickAddToCart}/>
            :
