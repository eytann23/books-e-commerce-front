...
const Header = () => {
	...
	const onClickMenu=()=>{
		setDisplayVerticalMenu(displayVerticalMenu=>!displayVerticalMenu);
	}
	const onClickVerticalMenuLink=()=>{
		if(displayVerticalMenu)
			setDisplayVerticalMenu(false)
	}
	...
	return(
		<div className="header">
			<svg onClick={onClickMenu} className="menu__icon" width="24" height="24" viewBox="0 0 24 24"><path d="M24 6h-24v-4h24v4zm0 4h-24v4h24v-4zm0 8h-24v4h24v-4z"/></svg>
			...
			{displayVerticalMenu && <div className="overlay" onClick={onClickOutsideMenu}></div>}
			<div className={displayVerticalMenu?"nav-links__containter display":"nav-links__containter"}>
				<NavLink to="/home" activeClassName="header-active-link" onClick={onClickVerticalMenuLink}>Home</NavLink>
				<NavLink to="/contact" activeClassName="header-active-link" onClick={onClickVerticalMenuLink}>Contact</NavLink>
				<NavLink to="/about" activeClassName="header-active-link" onClick={onClickVerticalMenuLink}>About</NavLink>
				<NavLink to="/cart" className="cart__button" activeClassName="header-active-link" onClick={onClickVerticalMenuLink}>
